"""
Base classes for SetCon datasets with common functionality.
"""
...
class SetConDatasetMixin:
    """
    Mixin class containing common functionality for SetCon datasets.
...
class SetConBaseDataset(Dataset, SetConDatasetMixin):
    """
    Base dataset class for SetCon datasets.
