...
class SetConQwenVideoDetectorAdapter(nn.Module):
    ...
    def _collect_qwen_dets(
        ...
        pred_list = self.qwen_model.decode_hidden_states(
            image=frame_pil,
    ...
    def _ensure_video_cache(self, img_batch: torch.Tensor, text_prompt: str):
        ...
        hs_result = self.qwen_model.infer_hidden_states(
    ...
    def forward_video_grounding_multigpu(self, **kwargs):
        ...
        boxes, masks, scores = self._collect_qwen_dets(
