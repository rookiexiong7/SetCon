...
def _build_qwen_model_bundle(
    qwen_model_name_or_path: str, device,
    processor_name_or_path: Optional[str] = None,
    tokenizer_name_or_path: Optional[str] = None,
    torch_dtype: Optional[torch.dtype] = None,
):
    processor = AutoProcessor.from_pretrained(
        processor_name_or_path or qwen_model_name_or_path, trust_remote_code=True
    )
    tokenizer = AutoTokenizer.from_pretrained(
        tokenizer_name_or_path or qwen_model_name_or_path, trust_remote_code=True
    )
...
def build_setcon_video_model(
    ...
    processor_name_or_path: Optional[str] = None,
    tokenizer_name_or_path: Optional[str] = None,
    qwen_model: Optional[nn.Module] = None,
    qwen_processor=None,
    qwen_tokenizer=None,
    ...
    if qwen_model is None or qwen_processor is None or qwen_tokenizer is None:
        qwen_model, qwen_processor, qwen_tokenizer = _build_qwen_model_bundle(
            qwen_model_name_or_path=qwen_model_name_or_path, device=device,
