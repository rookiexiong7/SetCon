...
from third_parts.sam3.train.utils.train_utils import makedir, register_omegaconf_resolvers
...
if __name__ == "__main__":
    initialize_config_module("third_parts.sam3.train", version_base="1.2")
