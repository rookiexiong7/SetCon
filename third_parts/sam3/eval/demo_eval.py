...
from third_parts.sam3.eval.coco_eval import CocoEvaluator
from third_parts.sam3.train.masks_ops import compute_F_measure
from third_parts.sam3.train.utils.distributed import is_main_process
