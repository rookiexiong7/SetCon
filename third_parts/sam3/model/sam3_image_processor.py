...
class Sam3Processor:
    ...
    def __init__(self, model, resolution=1008, device="cuda", confidence_threshold=0.5, disable_presence_token=True):
        self.model = model
        ...
        self.disable_presence_token = disable_presence_token
    ...
    def _forward_grounding(self, state: Dict):
        ...
        if self.disable_presence_token:
            presence_score = torch.ones_like(presence_score)
