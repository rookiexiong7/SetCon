...
from third_parts.sam3.model.memory import SimpleMaskEncoder

from third_parts.sam3.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames

from third_parts.sam3.sam.mask_decoder import MaskDecoder, MLP
from third_parts.sam3.sam.prompt_encoder import PromptEncoder
from third_parts.sam3.sam.transformer import TwoWayTransformer
from third_parts.sam3.train.data.collator import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _compile_all_components(self):
        ...
        from third_parts.sam3.perflib.compile import compile_wrapper
